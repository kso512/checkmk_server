...
| checkmk_server_version | Version of CheckMK RAW edition to install | `2.4.0p16` |
...
| -------------------------------- | ------------------------------------------------------------------------- |
| Debian 11 "bullseye"             | `sha256:446cf0f1d4b0752d1223c65d653bea42ac64cdb100b5f6d29d06b7530b4c03ac` |
| Debian 12 "bookworm"             | `sha256:42b07d865a54b85c1f6e742957e2a5990ed1186942fc53fc729ae5c71636e59d` |
| Debian 13 "trixie"               | `sha256:d671528449b2613d9576f4336d2837858e348dc02f28e683eb845f964e035deb` |
| Ubuntu 22.04 "jammy" (*default*) | `sha256:978d9cc4af1285aa159e362454603479156f02be366717e06f46de81ea8b167a` |
| Ubuntu 24.04 "noble"             | `sha256:54d5140577e86e5505b40b73a81aa266e118a8a7ab2e31d612adf47062d9f428` |
...
Tested using the included `./test/test_all_distros.sh` command, ran from the main role directory:
    ...
    =00= Running container for distro: debian11
    -01- Testing playbook for no failures in distro: debian11
    failed=0
    -02- Testing playbook for no changes (idempotence) in distro: debian11
    changed=0

%<-- snip -->%

    -03- Testing for CheckMK Raw Edition default site in distro: ubuntu2404
    test             2.4.0p13.cre     default version 
    -04- Testing for running status of CheckMK site in distro: ubuntu2404
    OVERALL 0
    -05- Removing container for distro after successful tests: ubuntu2404
    <docker container id>
